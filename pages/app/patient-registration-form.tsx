...
function saveForm(form: RegistrationForm) {
  return axios.post(
    `https://dotw-hikma.azurewebsites.net/api/admin/update_patient_registration_form`,
    {
      form: {
        ...form,
...
export default function PatientRegistrationForm() {
  ...
  */
  useEffect(() => {
    axios
      .get(`https://dotw-hikma.azurewebsites.net/api/admin/get_patient_registration_forms`, {
        headers: {
          Authorization: String(localStorage.getItem('token')),
        },
      })
